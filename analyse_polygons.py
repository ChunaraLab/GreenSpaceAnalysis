...
def get_args(command_line_arguments=sys.argv[1:]):
    ...
    parser.add_argument("-wl", "--loader", default="25cm RGB aerial", choices=loader_names,
...
def main(command_line_arguments):
    ...
    with open('polygon.geojson') as geojson_file:
    ...
    # print("********* json_features is: *********")
    # print(json_features)

    print("********* vegetation_indices is: *********")
    print(vegetation_indices)

    # print("********* args.downsampled_images is: *********")
    # print(args.downsampled_images)

    # print("********* args.only_paint_vegetation is: *********")
    # print(args.only_paint_vegetation)


    feature_indices, vegetation_presences, image_filenames = calculate_feature_indices(map_loader, json_features, vegetation_indices, output_folder_name,
    ...
    for i in range(len(vegetation_presences)):
        np.save(output_folder_name+'/'+image_filenames[i]+'.npy', np.array(vegetation_presences[i]))
